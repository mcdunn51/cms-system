...

{
    ...
    $comment_content = $_POST['text_area'];
 ...
 ?>
                ...
                <div class="well">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-group">
                            <label for="form">Your Comment:</label>
...
<div class="media">
    <a class="pull-left" href="#">
        <img class="media-object" src="images/avatar_placeholder.jpg" style="width:60px" alt="">
    </a>
